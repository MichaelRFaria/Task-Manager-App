...
I wanted to get familarised with full-stack development to prepare me for my "Individual Project" module for my final year of university, where I wanted to build the largest scale project I've ever worked on.
I decided to make a simple task manager program as I saw the scalability potential, from being a simple, bare bones CRUD app to a highly customisable, and extensive productivity app. 

- React was chosen due to prior experience and its widespread use.
- Spring Boot was chosen due to it being a Java framework, and Java being a language I have worked with extensively.
- PostgreSQL was chosen due to prior experience and its compatibility with Spring Boot.
